...
set(ylabel_hand,'Fontname', 'Times New Roman', 'Fontsize', 24);
legend_hand = legend(legend_string(1:n));
set(legend_hand,'Fontname', 'Times New Roman', 'Fontsize', 24, 'Location', 'NorthWest');
...
xlabel_hand=xlabel('Number of queries');
set(xlabel_hand,'Fontname', 'Times New Roman', 'Fontsize', 24);
ylabel_hand=ylabel('Average run time per query (\mus)');
set(ylabel_hand,'Fontname', 'Times New Roman', 'Fontsize', 24);
legend_hand = legend(legend_string(1:n));
set(legend_hand,'Fontname', 'Times New Roman', 'Fontsize', 24);