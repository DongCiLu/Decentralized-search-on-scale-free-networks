...
cmd1="mpiexec -n n_machines --hostfile /home/$USER/machines ./${exec_folder}/ds_dist_opt --graph ./datasets/graphname_wcc.txt --ncpus 2 --saveprefix graphname_class_n_machinesm_n_expq --num_tree n_tree --num_query n_exp --input_file ./${testcase_folder}/graphname_testcases.txt"
