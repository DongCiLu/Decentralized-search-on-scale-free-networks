...
n_machines=(1)
n_tree=(1)
posfix=("real") # if use real, dont forget to change the testcase directory

pre1="mkdir ./${res_folder}/class/"
pre2="bash -x /home/$USER/PowerGraph/scripts/mpirsync"
cmd1="mpiexec -n n_machines --hostfile ./machines ./${exec_folder}/ds_dist_opt --graph ./datasets/graphname_wcc.txt --ncpus 20 --saveprefix graphname_class_n_machinesm_n_expq --num_tree n_tree --num_query n_exp --input_file ./${testcase_folder}/graphname_testcases_wr.txt"
